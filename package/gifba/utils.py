...
def gifba_vis(F, ax=None, 
			  line_lab=None):
	"""Plot the cumulative flux values from gifba results. 
	...
	Args:
		...
		ax (matplotlib.axes.Axes, optional): 
			Matplotlib Axes to plot gifba results. 
			Defaults to None.
	...
	Returns:
		ax (matplotlib.axes.Axes, optional): 
			Matplotlib Axes to plot gifba results. Returns for saving or
...
def load_example_models():
	...
	"""
	mat_path = files("gifba").joinpath("AGORA2_Models", "Escherichia_coli_str_K_12_substr_MG1655.mat")
	example_EC = cb.io.load_matlab_model(str(mat_path))

	mat_path = files("gifba").joinpath("AGORA2_Models", "Bacteroides_thetaiotaomicron_3731.mat")
